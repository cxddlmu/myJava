...
public class TestJedis {
    private static final String ipAddr = "192.168.0.104";
    ...
    public void test() throws Exception {
        jedis.flushDB();
        String cache1Str = "cache1";
        Map cache2Map = new HashMap();
        List cacheList = new ArrayList();
        cacheList.add("val1");
        cacheList.add("val2");
        Set cache4Set = new HashSet();
        jedis.lpush("cacheList", String.join(",", cacheList));
        jedis.lpushx("cacheList", "val3");
        jedis.lpushx("cacheList1", "val4");
        System.out.println(jedis.lrange("cacheList", 0, -1));
    }
    ...
    public void testList() {
        ...
        jedis.lpushx("collections", "linkedList");//将值 value 插入到列表 key 的表头，当且仅当 key 存在并且是一个列表。
    ...
    public void testSet() {
        ...
        jedis.sinterstore("store", "eleSet1", "eleSet2");
        System.out.println("eleSet1和eleSet2的交集:" + jedis.smembers("store"));
    ...
    public void testHash() {
        ...
        System.out.println(jedis.hscan("hash", "0", scanParams).getResult());
    ...
    public void testSortedSet() {
        ...
        System.out.println("zset中的所有元素：" + jedis.zrevrangeByScore("zset", 0, 100));
        System.out.println("zset中的所有元素：" + jedis.zrangeByScoreWithScores("zset", 0, 100));
        System.out.println("zset中的所有元素：" + jedis.zrevrangeByScoreWithScores("zset", 0, 100));
        System.out.println("zset中key2的分值：" + jedis.zscore("zset", "key2"));
        System.out.println("zset中key2的排名：" + jedis.zrank("zset", "key2"));//score 小到大
        System.out.println("zset中key2的排名：" + jedis.zrevrank("zset", "key2"));//score 大到小
        ...
        System.out.println("zset中的所有元素：" + jedis.zrange("zset", 0, -1));
        jedis.zremrangeByRank("zset", 0, 1);
        jedis.zremrangeByScore("zset", 0, 1);
        jedis.zremrangeByLex("zset", "[key3", "(key4");
