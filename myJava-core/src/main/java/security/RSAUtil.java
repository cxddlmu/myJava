...
public class RSAUtil {
    ...
    private static final String DEFAULT_PRIVATE_KEY=
            "MIICdQIBADANBgkqhkiG9w0BAQEFAASCAl8wggJbAgEAAoGBAKEPNyPD+taAXCfG" + "\r" +
                    ...
                    "1NMLzI2ZfUoX" + "\r";
    private static final String privatekeyFile = "/Users/cuixiaodong/privatekey.key";
    private static final String publickeyFile = "/Users/cuixiaodong/pubkey.key";

    /**
     * 私钥
     */
    private PrivateKey privateKey; //rsaprivate
    ...
    public void loadPrivateKey(InputStream in) throws Exception{
        ...
        this.privateKey=new PrivateKeyReader(privatekeyFile).getPrivateKey();
    ...
    public static void main(String[] args){
        ...
        //加载公钥
        try {
            rsaEncrypt.loadPublicKey(new FileInputStream(publickeyFile));
        ...
        //加载私钥
        try {
            rsaEncrypt.loadPrivateKey(new FileInputStream(privatekeyFile));
        ...
        //测试字符串
        String encryptStr= "TestThead String chaijunkun";
